...
#SBATCH --time=0-3:00               # Max run time (D-HH:MM). Max is 7 days (168h).
#SBATCH --output=%x-%j-benchmark.out           # Output file
#SBATCH --error=%x-%j-benchmark.err            # Error file

# --- Fir GPU Resource Requests ---
# The GPU nodes have 48 cores and 4 H100 GPUs.
# Recommended practice is 12 CPU cores and approx 281 GB RAM per full H100.
# Request 1 full H100 GPU:
#SBATCH --gpus=h100:1                # Request one full H100 (80GB)
